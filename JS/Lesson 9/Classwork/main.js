...
for (const simpson of simpsons) {
    ...
    divElement.innerText = `${simpson.name} \n ${simpson.surname} \n ${simpson.age} \n ${simpson.info} \n\n`
...
for (const simpson of simpsons) {
    ...
    nameElement.innerText = `Name - ${simpson.name}`;

    let surnameElement = document.createElement('h2');
    surnameElement.innerText = `Surname - ${simpson.surname}`;

    let ageElement = document.createElement('h4');
    ageElement.innerText = `Age - ${simpson.age}`;
    ...
    divElement.append(nameElement, surnameElement, ageElement, infoElement, imgElement);
    document.body.appendChild(divElement);
