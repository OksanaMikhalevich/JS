...
for (let simpson of simpsons) {
    document.write(`<div>NAME - ${simpson.name} <br> SURNAME - ${simpson.surname} <br> AGE - ${simpson.age} <br> INFO - ${simpson.info} <br>
...
for (let product of products) {
    document.write(`<h3 class="product_title">${product.title}. Prise - ${product.price}`);
    document.write(`<img src="${product.image}" alt="" class="product_image"/>`);
}
document.write(`</div>`);
document.write(`</div>`);
